...
if __name__ == "__main__":
    ...
    for h in h_list:
        ...
        result_dict['f_data'] = [f(x, None) for x in data]
        result_dict['f_pred1'] = [ml_f(x, None, model) for x in data]
        result_dict['f_pred2'] = [ml_f(x, None, model) for x in pred]
        # TODO: collect errors from derivatives and integrated dynamics
        error_dict[h] = result_dict
